...
\begin{document}
	...
	A partir de esta descomposición, los documentos se representan como $U_k \Sigma_k$ y las consultas se proyectan como $q_k = q V_k^T$.
	...
	\begin{itemize}
		\item \texttt{data/index/lsi_model.pkl}
		\item \texttt{data/index/doc_vectors.npy}
	\end{itemize}
